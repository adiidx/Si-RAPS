...
class Dokumen_akreditasi extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view("admin/dokumen_akreditasi", $data);       
    }
    ...
    public function standar_1()
    {
        ...
        $this->load->view("admin/tabel_standar1", $data);      
    }
    ...
    public function standar_2()
    {
        ...
        $this->load->view("admin/tabel_standar2", $data);      
    }
    ...
    public function standar_3()
    {
        ...
        $this->load->view("admin/tabel_standar3", $data);      
    }
    ...
    public function standar_4()
    {
        ...
        $this->load->view("admin/tabel_standar4", $data);      
    }
    ...
    public function standar_5()
    {
        ...
        $this->load->view("admin/tabel_standar5", $data);      
    }
    ...
    public function standar_6()
    {
        ...
        $this->load->view("admin/tabel_standar6", $data);      
    }
    ...
    public function standar_7()
    {
        ...
        $this->load->view("admin/tabel_standar7", $data);      
    }
    ...
    public function standar_8()
    {
        ...
        $this->load->view("admin/tabel_standar8", $data);      
    }
    ...
    public function standar_9()
    {
        ...
        $this->load->view("admin/tabel_standar9", $data);      
    }
}