			            ...
			            ?>
			                <tr>
				                ...
				                <td style="text-align: center;">
						            <a class="btn btn-success btn-sm" title="Download" href='<?php echo base_url() ?>admin/dokumen_akreditasi/download_dokumen_pelengkap/<?php echo $dokumen->nama_dokumen; ?>'><i class="fas fa-download"></i><b> DOWNLOAD</b></a>
						        </td>
			                </tr>
			            <?php 
			                }
