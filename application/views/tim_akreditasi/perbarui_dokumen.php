		...
		<div class="row">
		   	<div class="col-md-12">
		   		<div class="box box-default">
				    ...
				    <div class="box-body">
					    <div class="row">
					        <?php echo form_open_multipart('tim_akreditasi/kelola_dokumen/perbarui') ?>
					            ...
					            <div class="col-md-8">
					                <div class="box-body form-horizontal">
					                	<div class="form-group">
					                      	...
					                      	<div class="col-sm-8">
					                      		<input type="hidden" name="fid_dokumen" class="form-control" style="text-transform: capitalize;" value="<?php echo $data_dokumen->id_dokumen ?>">
